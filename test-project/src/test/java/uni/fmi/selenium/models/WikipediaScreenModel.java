...
public class WikipediaScreenModel {

	private WebDriver driver;
	private WebElement queryFiled;
	private WebElement searchButton;

	public WikipediaScreenModel(final WebDriver driver) {
		this.driver = driver;
	}
	...
	public WebElement getQueryField() {
		queryFiled = driver.findElement(By.id("searchInput"));
		return queryFiled;
	}
